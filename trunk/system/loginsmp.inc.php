...
if( !isset($_SESSION['PREGO_ADMIN']['STAFF_SEQ']) || $_SESSION['PREGO_ADMIN']['STAFF_AUTH'] != '3' ){
...
$pregomenu=array(PREGO_ACCOUNT => array("name" => "アカウントデスク","class" => "icon_account" ,
				...
				PROGE_CORPORATE => array("name" => "クライアント様デスク","class" => "icon_corporate" ,
					"li" =>array(
					"corporate_unregistered"  => array("name" => "未登録一覧"),
					"corporate_search"   => array("name" => "クライアント検索"),
					"corporate_edit" => array("name" => "クライアント情報")
					)),
				PROGE_SPECIALIST => array("name" => "スペシャリストデスク","class" => "icon_specialist" ,
					"li" =>array(
					"specialist_unregistered"  => array("name" => "未登録一覧"),
					"specialist_search"   => array("name" => "スペシャリスト検索"),
					"specialist_edit"	=> array("name" => "スペシャリスト情報")		
					)),
				PROGE_OPPORTUNITY => array("name" => "約定デスク","class" => "icon_opportunity" ,
					"li" =>array(
					"opportunity_search"  => array("name" => "案件検索"),
